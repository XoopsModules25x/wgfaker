 ...
 */
function xoops_module_pre_uninstall_wgfaker(\XoopsModule $module)
{
 ...
 */
function xoops_module_uninstall_wgfaker(\XoopsModule $module)
{
    $moduleDirName      = \basename(\dirname(__DIR__));
    $moduleDirNameUpper = \mb_strtoupper($moduleDirName);

    $helper = Wgfaker\Helper::getInstance();
