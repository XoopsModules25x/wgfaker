...
\define('_AM_WGFAKER_DATATYPE_EMAIL', '{firstname}.{lastname}@domain.com');
...
\define('_AM_WGFAKER_DATATYPE_IMAGE', '{Sample image}');
...
\define('_AM_WGFAKER_DATATYPE_FILE', '{Sample file}');
